...
class ContentCollectionViewMainCell: UICollectionViewCell{
    ...
    override func layoutSubviews() {
        ...
        categoryButton.setTitle("카테고리 d", for: .normal)
    ...
    @objc func movieButtonTapped(sender:UIButton!){
        print("Test : movieButton BUTTON Tapped")
    }
    @objc func categoryButtonTapped(sender:UIButton!){
        print("Test : categoryButton BUTTON Tapped")
    }
    @objc func plusButtonTapped(sender:UIButton!){
        print("Test : plusButtonTapped BUTTON Tapped")
    }
    @objc func infoButtonTapped(sender:UIButton!){
        print("Test : infoButtonTapped BUTTON Tapped")
    }
    @objc func playButtonTapped(sender:UIButton!){
        print("Test : playButtonTapped BUTTON Tapped")
    }
